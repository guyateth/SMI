...
TEST(VectorDataTypes, MPIinit)
{
    ASSERT_EQ(rank_count,8);
}

TEST(VectorDataTypes, DoubleRailFloat4)
{
    ...
    hlslib::ocl::Kernel kernel = context->CurrentlyLoadedProgram().MakeKernel("test_double_rail_float4");
...
int main(int argc, char *argv[])
{
    ...
    if(argc==2)
        ...
        program_path="emulator_<rank>/vector_data_types.aocx";
    ...
    comm=SmiInit_vector_data_types(my_rank, rank_count, ROUTING_DIR, *context, program, buffers);
