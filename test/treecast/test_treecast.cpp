...
TEST(Treecast, IntegerMessagesAD)
{
...
int main(int argc, char *argv[])
{
    ...
    if(argc==2)
        ...
        program_path="emulator_<rank>/treecast.aocx";
    ...
    comm=SmiInit_treecast(my_rank, rank_count, ROUTING_DIR, *context, program, buffers);
